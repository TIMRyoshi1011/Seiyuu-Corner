...
CREATE TABLE `catalog_assignment` (
  `STAFF_ID` INT,
  `ANIME` VARCHAR(20),
  PRIMARY KEY (`STAFF_ID`),
...
CREATE TABLE `seasonal_calendar_2` (
  `SUNDAY` VARCHAR(30),
  `MONDAY` VARCHAR(30),
  `TUESDAY` VARCHAR(30),
...
CREATE TABLE `seasonal_assignment` (
  `STAFF_ID` INT UNIQUE,
...
INSERT INTO seasonal_calendar VALUES
('1 - Yurie Igoma', '2 - Takeo Otsuka', '3 - Atsumi Tanezaki', '4 - Shogo Sakata', '5 - Saori Onishi', '6 - Makoto Furukawa', '7 - Yu Serizawa'),
('8 - Daisuke Namikawa', '9 - Megumi Han', '10 - Yuya Hirose', '11 - Maria Naganawa', '12 - Kazuki Ura', '13 - Maaya Uchida', '14 - Tomoaki Maeno'),
('15 - Yumi  Uchiyama', '16 - Shun Horie', '17 - Hina Tachibana', '18 - Kentaro Ito', '19 - Shizuka Ito', '20 - Tatsuya Sato', '21 - Ikumi Hasegawa'),
('22 - Kent Ito', '23 - Miku Ito', '24 - Yuma Uchida', '25 - Lynn', '26 - Koki Uchiyama', '27 - Fairuz Ai', '28 - Yuichiro Umehara');

INSERT INTO seasonal_calendar_2 VALUES
('1 - Yumiri Hanamori', '2 - Yoji Ueda', '3 - Mutsumi Tamura', '4 - Ryota Suzuki', '5 - Manaka Iwami', '6 - Nobuhiko Okamoto', '7 - Misaki Kuno'),
('8 - Shoya Chiba', '9 - Ayane Sakura', '10 - Taku Yashiro', '11 - Akai Kito', '12 - Yuki Ono', '13 - Mao', '14 - Gakuto Kajiwara'),
('15 - Rumi Okubo', '16 - Shuichiro Umeda', '17 - Miyuki Sawashiro', '18 - Kohei Amazaki', '19 - Ayaka Nanase', '20 - Shunuchi Toki', '21 - Aya Yamane'),
('22 - Chikairo Kobayashi', '23 - Haruka Shiraishi', '24 - Yohei Azakami', '25 - Saori Hayami', '26 - Yoshitsugu Matsuoka', '27 - Kana Hanazawa', '28 - Chiaki Kobayashi'),
('29 - Kana Ichinose', '30 - Junya Enoki', '31 - Sayumi Suzushiro', NULL, NULL, NULL, NULL);

INSERT INTO seasonal_assignment VALUES
(1, 'Thursday'),
(2, 'Sunday'),
(3, 'Friday'),
(4, 'Monday'),
...
INSERT INTO catalog_assignment (ANIME, STAFF_ID) VALUES
('Oshi No Ko S3', 7),
('Frieren S2', 1);
...
SELECT * FROM seasonal_calendar_2;
SELECT * FROM seasonal_assignment;
SELECT * FROM catalog_assignment;
...
SELECT CONCAT(s.FIRST_NAME, ' ', s.LAST_NAME) AS Assigned, ca.ANIME 
FROM catalog_assignment ca JOIN staff s ON ca.STAFF_ID = s.STAFF_ID;

SELECT CONCAT(s.FIRST_NAME) AS assigned, sa.DAY_OF_WEEK 
FROM seasonal_assignment sa JOIN staff AS s ON s.STAFF_ID = sa.STAFF_ID;